...
export default function Home() {
  ...
  //bringing in contract address and abi
  const contractAddress = "0x06E0fC3D4fD709120fA8e199794B5bDF212Ff94F";
  const contractABI = abi.abi;

  const getKeyboards = async () => {
    //using state variables to show a loading prompt, once asynchrnous events are done
    //waiting, setMining will be turned to false
